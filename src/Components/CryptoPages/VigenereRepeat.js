...
function VigenereRepeat() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:4000/vigenerrepeat", {
        method: "POST",
  ...
  return (
    <>
      <div style={{ height: 690, backgroundColor: "#163823" }}>
        ...
        <h1 className="header">Vigenere Repeating Key Cipher</h1>
