...
function VigenereAuto() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:4000/vigenerauto", {
        method: "POST",
  ...
  return (
    <>
      <div style={{ height: 690, backgroundColor: "#163823" }}>
        ...
        <h1 className="header">Vigenere Autokey Cipher</h1>
